...
class DayRecordsAdapter(val activity: AppCompatActivity, val dataset: MutableList<Record>, val coordinatorLayout: CoordinatorLayout) : RecyclerView.Adapter<DayRecordsAdapter.ViewHolder>() {
        ...
        popup.setOnMenuItemClickListener { menuItem: MenuItem ->
            when (menuItem.itemId) {
                R.id.action_add_more -> {
                    NewRecordDialog.addMore(activity, item).show()
                }
                R.id.action_edit -> {
                    NewRecordDialog.edit(activity, item).show()
                }
                R.id.action_delete -> {
