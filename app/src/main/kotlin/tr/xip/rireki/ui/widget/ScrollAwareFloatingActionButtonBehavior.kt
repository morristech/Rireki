...
/**
 * A FloatingActionButton.Behavior that reacts to vertical scroll events, showing or hiding the FloatingActionButton.
 */
class ScrollAwareFloatingActionButtonBehavior(context: Context? = null, attrs: AttributeSet? = null) : FloatingActionButton.Behavior() {
